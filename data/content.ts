...
export const contentData: ContentData = [
  {
    ...
    items: [
      ...
      },
      {
        color: "#32323A",
        title: "CDG29",
        subTitle: "Alternance - Technician",
    ...
    items: [
      {
        ...
        description: "Specialized in Development Technology / Management.",
      },
      {
    ...
    items: [
      {
        ...
        subTitle: "Native",
        date: "",
        description: "Native language, fluent in all aspects.",
      },
      {
        title: "English",
        ...
        date: "",
        description:
          "Good command of English for professional and technical communication.",
      },
    ],
  },
  {
    ...
    items: [
      {
        title: "Ooof.dev",
        subTitle: "Website for freelancing",
        date: "2024",
        description: "Website for ooof.dev commercial name for freelancing.",
      },
      {
        title: "VSCode Extension - VSCode Git Commit",
        subTitle: "Open-source VSCode extension",
        date: "2020",
        description:
          "Open-source VSCode extension to manage commit messages with a customizable template. The goal is to allow maximum possibilities to meet as many needs as possible.",
      },
      {
        title: "OUTrans - Counter",
        subTitle: "Multi-device synced counter",
        date: "2024",
        description:
          "A multiple devices synced counter for Outtrans 15 years association event to manage entries in the event.",
      },
      {
        title: "PoachiBot",
        subTitle: "Complex Twitch bot",
        date: "2023 - 2024",
        description:
          "A complex Twitch bot for Poachimpa's streaming to help create engagement, track events, get statistics, and manage viewers.",
      },
      {
        title: "Chariteam",
        subTitle: "Association website",
        date: "2023",
        description:
          "A website for the Chariteam association to track events and donations.",
      },
      {
        ...
        date: "2016 - 2023",
        description:
          "A Portfolio to showcase some of my projects and explore technologies, with 6 different versions since 2016.",
      },
      {
        title: "Subiby",
        subTitle: "Subscription tracking app",
        date: "2023",
        description:
          "Subiby is a subscription tracking application, developed for personal use. It provides a place to list all subscriptions and a way to track when account charges are added.",
      },
      {
        title: "Britch",
        subTitle: "Chrome extension for Twitch",
        date: "2023",
        description:
      ...
      },
      {
        ...
        date: "2022",
        description:
          "Diagevol is a website for the product of Alpha8. I developed the initial version based on a partial mockup.",
      },
      {
        title: "Meeting Discord Bot",
        subTitle: "Discord scheduling bot",
        date: "2021",
        description:
          "This is a Discord bot helping people to schedule games of AmongUs in weeks and days by providing availability information for everyone.",
      },
      {
        title: "And many more",
        subTitle: "",
